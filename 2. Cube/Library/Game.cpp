...
void Render() {
    ...
    // 위성 큐브 (2번): 중심 큐브를 기준으로 공전
    XMMATRIX rotationAroundCenter = XMMatrixRotationY(t);                     // 공전 회전
    XMMATRIX orbitRadius = XMMatrixTranslation(3.0f, 0.0f, 0.0f);             // 중심에서 반지름 3
    XMMATRIX selfRotation = XMMatrixRotationY(t * 5.0f);                      // 자전
